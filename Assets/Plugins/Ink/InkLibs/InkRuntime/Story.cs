...
namespace Ink.Runtime
{
    ...
    public class Story : Runtime.Object
    {
        ...
        {
            get { return state.currentErrors; }
        }
        ...
        {
            get { return state.currentWarnings; }
        }
        ...
        {
            get { return state.currentFlowIsDefaultFlow; }
        }
        ...
        {
            get { return state.variablesState; }
        }
        ...
        {
            get { return !_asyncContinueActive; }
        }
        ...
        void ContinueInternal(float millisecsLimitAsync = 0)
        {
            ...
            if (outputStreamEndsInNewline || !canContinue)
            {
                ...
                if (!canContinue)
                {
                    ...
                    if (
                        state.generatedChoices.Count == 0
                        && !state.didSafeExit
            ...
            if (!state.inStringEvaluation)
            {
                ...
                if (_stateSnapshotAtLastNewline != null)
                {
                    ...
                    var change = CalculateNewlineOutputStateChange(
                        ...
                        state.currentText,
                        _stateSnapshotAtLastNewline.currentTags.Count,
                        state.currentTags.Count
                    );
        ...
        void Step()
        {
            ...
            if (shouldAddToStream)
            {
                ...
                if (varPointer && varPointer.contextIndex == -1)
                {
                    ...
                    var contextIdx = state.callStack.ContextForVariableNamed(
        ...
        void VisitChangedContainersDueToDivert()
        {
            ...
            if (!previousPointer.isNull)
            {
                Container prevAncestor =
                    previousPointer.Resolve() as Container
            ...
            )
            {
                ...
                bool enteringAtStart =
                    currentContainerAncestor.content.Count > 0
                ...
                switch (evalCommand.commandType)
                {
                    ...
                    case ControlCommand.CommandType.PopTunnel:
                        ...
                        if (state.TryExitFunctionEvaluationFromGame())
                        {
                            ...
                            state.callStack.currentElement.type != popType
                    ...
                    case ControlCommand.CommandType.ReadCount:
                        ...
                        var container =
                            ContentAtPath(divertTarget.targetPath).correctObj as Container;
                    ...
                    case ControlCommand.CommandType.VisitIndex:
                        var count =
                            state.VisitCountForContainer(state.currentPointer.container) - 1; // index not count
                    ...
                    case ControlCommand.CommandType.ListFromInt:
                        ...
                        if (
                            listDefinitions.TryListGetDefinition(
                                listNameVal.value,
                                out foundListDef
                            )
                        )
                    ...
                    case ControlCommand.CommandType.ListRange:
                    {
                        ...
                        var result = targetList.value.ListWithSubRange(
                            min.valueObject,
                            max.valueObject
                        );
        ...
        /// <param name="arguments">The arguments that the ink function takes, if any. Note that we don't (can't) do any validation on the number of arguments right now, so make sure you get it right!</param>
        public object EvaluateFunction(
            string functionName,
        ...
        public bool TryGetExternalFunction(
            string functionName,
            out ExternalFunction externalFunction
        )
        {
        ...
        public void BindExternalFunctionGeneral(
            string funcName,
        ...
        public void ValidateExternalBindings()
        {
            ...
            else
            {
                var message = string.Format(
                    "ERROR: Missing function binding for external{0}: '{1}' {2}",
        ...
        public void RemoveVariableObserver(
            VariableObserver observer = null,
            string specificVariableName = null
        )
        {
